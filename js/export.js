...
// Esta versao usa os arquivos do FFmpeg.wasm hospedados no proprio site
// (pasta vendor/ffmpeg/), evitando problemas de CORS com CDNs externos.
...
async function ensureFFmpeg(){
  ...
  ffmpegLoading=(async()=>{
    ...
    // Caminhos LOCAIS (mesma origem do site) - nada de CDN externo aqui.
    // Isso evita qualquer erro de CORS ao criar o Worker interno do FFmpeg.
    await ff.load({
      coreURL: "vendor/ffmpeg/core/ffmpeg-core.js",
      wasmURL: "vendor/ffmpeg/core/ffmpeg-core.wasm",
      classWorkerURL: "vendor/ffmpeg/814.ffmpeg.js"
    });
