...
async function ensureFFmpeg(){
  ...
  ffmpegLoading=(async()=>{
    ...
    const classWorker=await blobURL("https://cdnjs.cloudflare.com/ajax/libs/ffmpeg/0.12.15/umd/814.ffmpeg.js","text/javascript");
    try{await ff.load({coreURL:core,wasmURL:wasm,classWorkerURL:classWorker});}
    finally{URL.revokeObjectURL(core);URL.revokeObjectURL(wasm);URL.revokeObjectURL(classWorker);}
    ffmpegInstance=ff;
    return ff;
  })();
